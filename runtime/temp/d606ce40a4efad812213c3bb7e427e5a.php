<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\tpform\lists.htm";i:1548678017;s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\header.htm";i:1547774329;s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\left.htm";i:1549083593;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<tr>
    <td align="center"><?php echo $vo['id']; ?></td>
     <td align="center"><?php echo mb_substr($vo['chenhu'],0,20,'utf-8');if(strlen($vo['chenhu'])>20){echo '...';}?></td>

    <td align="center"><?php echo mb_substr($vo['shouji'],0,20,'utf-8');if(strlen($vo['shouji'])>20){echo '...';}?></td>
    <td align="center"><?php echo mb_substr($vo['mianji'],0,20,'utf-8');if(strlen($vo['mianji'])>20){echo '...';}?></td>

    <td align="center"><?php if($vo['fang'] == 0): ?>旧房<?php else: ?>新房<?php endif; ?></td>
