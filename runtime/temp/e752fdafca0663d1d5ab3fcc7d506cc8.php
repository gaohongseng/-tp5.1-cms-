<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:99:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\tpqtarticle\tp3wenzhanlst.htm";i:1547708394;s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\header.htm";i:1547774329;s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\left.htm";i:1549083566;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<li <?php if($lowercon == 'tpfield'): ?>class='open'<?php endif; ?>>
        <a href="#" class="menu-dropdown">
...
<button type="button" tooltip="添加栏目" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href='<?php echo url('tp3wenzhanadd',array('catid'=>input('catid'),'typeid'=>input('typeid'))); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
...
<tr>
    <td align="center"><?php echo $vo['id']; ?></td>
     <td align="center"><?php echo mb_substr($vo['shuomin'],0,20,'utf-8');if(strlen($vo['shuomin'])>20){echo '...';}?></td>

    <td align="center"><?php echo mb_substr($vo['title'],0,20,'utf-8');if(strlen($vo['title'])>20){echo '...';}?></td>
    <td align="center"><?php echo mb_substr($vo['desc'],0,20,'utf-8');if(strlen($vo['desc'])>20){echo '...';}?></td>



    <td align="center"><img src="<?php if($vo["thumb"] != ""): ?>__IMG__/<?php echo $vo['thumb']; else: ?>__ADMIN__/images/defaultpic.gif<?php endif; ?>" alt="" style='width:50px;height:50px;'></td>
    ...
    <td align="center">
        <a href="<?php echo url('tp3wenzhanedit',array('theid'=>$vo['id'],'catid'=>input('catid'),'typeid'=>input('typeid'))); ?>" class="btn btn-primary btn-sm shiny">
            <i class="fa fa-edit"></i> 编辑
        </a>
        <a href="#" onClick="warning('确实要删除吗','<?php echo url('tp3wenzhandel',array('theid'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
