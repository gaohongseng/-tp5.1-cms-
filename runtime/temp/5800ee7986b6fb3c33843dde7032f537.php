<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\tpsearch\lists.htm";i:1548296452;s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\header.htm";i:1547774329;s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\left.htm";i:1549185226;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url("tpsearch/add"); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
...
<?php if(is_array($searchRes) || $searchRes instanceof \think\Collection): $i = 0; $__LIST__ = $searchRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$search): $mod = ($i % 2 );++$i;?>                        
    <tr>
        <td align="center"><?php echo $search['id']; ?></td>
        <td align="center"><input type='text' style='width:50px;text-align:center;' value="<?php echo $search['sort']; ?>" name='<?php echo $search['id']; ?>'></td>
        <td align="center"><?php echo $search['fenge']; ?></td>
        <td align="center">
            <a href="<?php echo url('tpsearch/edit',array('searchid'=>$search['id'])); ?>" class="btn btn-primary btn-sm shiny">
                <i class="fa fa-edit"></i> 编辑
            </a>
            <a href="#" onClick="warning('确实要删除吗', '<?php echo url('tpsearch/del',array('searchid'=>$search['id'])); ?>')" class="btn btn-danger btn-sm shiny">
