<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\tpfield\edit.htm";i:1549535940;s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\header.htm";i:1547774329;s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\left.htm";i:1549506592;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<span class="widget-caption">修改字段</span>
</div>
...
<div class="col-sm-6">
	<select name="model_id" id="" disabled='disabled'>
	...
	<option value="<?php echo $vo['id']; ?>" <?php if($fields['model_id'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['model_name']; ?></option>
...
<div class="col-sm-6">
<input class="form-control" id="username" placeholder="" name="field_cname" type="text" value="<?php echo $fields['field_cname']; ?>">
...
<div class="col-sm-6">
<input class="form-control" id="username" placeholder="" name="field_ename" type="text" value="<?php echo $fields['field_ename']; ?>">
...
<div class="form-group">
<label for="username" class="col-sm-2 control-label no-padding-right">字段类型</label>
<div class="col-sm-6">
...
<textarea class="form-control" id="form-field-8" placeholder="" name="field_values"  type="text" rows='6'><?php echo $fields['field_values']; ?></textarea>
...
$("select[name='field_type'] option[value=<?php echo $fields['field_type']; ?>]").attr('selected',true);
