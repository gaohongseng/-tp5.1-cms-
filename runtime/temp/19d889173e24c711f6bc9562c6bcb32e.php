<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\tpconf\lists.htm";i:1547708375;s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\header.htm";i:1547774329;s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\left.htm";i:1549339226;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<?php if(is_array($confres) || $confres instanceof \think\Collection): $i = 0; $__LIST__ = $confres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$conf): $mod = ($i % 2 );++$i;?>                        
    <tr>
        ...
        <td align="center"><input type='text' style='width:50px;text-align:center;' value="<?php echo $conf['sort']; ?>" name='<?php echo $conf['id']; ?>'></td>
...
下拉菜单
    ...
    <?php endif; ?>
        ...
        <td align="center">
            <a href="<?php echo url('tpconf/edit',array('confid'=>$conf['id'])); ?>" class="btn btn-primary btn-sm shiny">
                <i class="fa fa-edit"></i> 编辑
            </a>
            <a href="#" onClick="warning('确实要删除吗', '<?php echo url('tpconf/del',array('confid'=>$conf['id'])); ?>')" class="btn btn-danger btn-sm shiny">
