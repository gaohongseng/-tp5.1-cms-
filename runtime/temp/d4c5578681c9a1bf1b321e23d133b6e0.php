<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\tparthives\lists.htm";i:1549515099;s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\header.htm";i:1547774329;s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\left.htm";i:1549506592;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url("tparthives/add",array('modelid'=>input('modelid'),'cateid'=>input('cateid'))); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
...
<tbody>
    ...
    <tr>
        ...
        <td align="center">33</td>
<td align="center">33</td>
        <td align="center"><img src="__PUBLIC__/" height='30'>

        </td>
        <td align="center">
            <a href="<?php echo url('tparthives/edit'); ?>" class="btn btn-primary btn-sm shiny">
