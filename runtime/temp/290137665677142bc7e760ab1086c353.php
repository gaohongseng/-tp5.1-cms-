<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\tparttupian\lists.htm";i:1548836758;s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\header.htm";i:1547774329;s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\left.htm";i:1549506592;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('tparttupian/add',array('cateId'=>input('cateId'))); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
...
<?php if(input('typeid') or empty(input('cateId'))): if(is_array($listcate) || $listcate instanceof \think\Collection): $i = 0; $__LIST__ = $listcate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;if(is_array($list['arttupian']) || $list['arttupian'] instanceof \think\Collection): $i = 0; $__LIST__ = $list['arttupian'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
...
缩略图
        ...
        <td align="center">
            <a href="<?php echo url('tparttupian/edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                <i class="fa fa-edit"></i> 编辑
            </a>
            <a href="#" onClick="warning('确实要删除吗', '<?php echo url('tparttupian/del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
                <i class="fa fa-trash-o"></i> 删除
            </a>
        </td>
    </tr>

<?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; elseif(input('cateId')): if(is_array($listcate['arttupian']) || $listcate['arttupian'] instanceof \think\Collection): $i = 0; $__LIST__ = $listcate['arttupian'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
...
缩略图
        ...
        <td align="center">
            <a href="<?php echo url('tparttupian/edit',array('id'=>$vo['id'],'cateId'=>input('cateId'))); ?>" class="btn btn-primary btn-sm shiny">
                <i class="fa fa-edit"></i> 编辑
            </a>
            <a href="#" onClick="warning('确实要删除吗', '<?php echo url('tparttupian/del',array('id'=>$vo['id'],'cateId'=>input('cateId'))); ?>')" class="btn btn-danger btn-sm shiny">
                <i class="fa fa-trash-o"></i> 删除
            </a>
        </td>
    </tr>
