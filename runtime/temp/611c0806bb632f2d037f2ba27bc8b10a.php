<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\tpcate\edit.htm";i:1549068566;s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\header.htm";i:1547774329;s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\left.htm";i:1549506592;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<option value="<?php echo $vo['id']; ?>" <?php if($cates['modelid'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['model_name']; ?></option>
...
<option value="<?php echo $vo['id']; ?>,<?php echo $vo['level']; ?>" <?php if($cates['pid'] == $vo['id']): ?>selected="selected"<?php endif; ?>><?php if($vo['level'] != 0): ?>|<?php endif; ?><?php echo str_repeat('-',$vo['level']*4);?><?php echo $vo['catename']; ?></option>
    <?php endforeach; endif; else: echo "" ;endif; ?>
...
<div class="col-sm-6">
<input class="form-control" id="username" placeholder="" name="catename"  type="text" value="<?php echo $cates['catename']; ?>">
...
<div class="col-sm-6">
<input class="form-control" id="username" placeholder="" name="enname"  type="text" value="<?php echo $cates['enname']; ?>">
...
<div class="form-group">
<label for="group_id" class="col-sm-2 col-md-2 col-xs-2 control-label no-padding-right">缩略图</label>
...
<img src="<?php if($cates["thumb"] != ""): ?>__IMG__/<?php echo $cates['thumb']; else: ?>__ADMIN__/images/defaultpic.gif<?php endif; ?>" alt=""  height='50' style='display:inline-block;float:left;margin:0px 10px;'>
</div>  
...
<div class="radio" style='margin-left:10px;float:left;'><label><input  name="type" type="radio" value='1' <?php if($cates['type'] == 1): ?>checked<?php endif; ?>><span class="text">文章列表</span></label></div>

<div class="radio" style='margin-left:10px;float:left;'><label><input class="inverted" name="type" type="radio" value='2' <?php if($cates['type'] == 2): ?>checked<?php endif; ?>><span class="text" >单页</span></label></div>


<div class="radio" style='margin-left:10px;float:left;'><label><input class="inverted" name="type" type="radio" value='3' <?php if($cates['type'] == 3): ?>checked<?php endif; ?>><span class="text" >图片列表</span></label></div>


<!-- <div class="radio" style='margin-left:10px;float:left;'><label><input class="inverted" name="type" type="radio" value='3' <?php if($cates['type'] == 3): ?>checked<?php endif; ?>><span class="text">视频列表</span></label></div> -->
...
<div class="radio" style='margin-left:10px;float:left;'><label><input name="rec_index" type="radio" value='1' <?php if($cates['rec_index'] == 1): ?>checked<?php endif; ?>><span class="text">是</span></label></div>



<div class="radio" style='margin-left:10px;float:left;'><label><input name="rec_index" type="radio" value='0' <?php if($cates['rec_index'] == 0): ?>checked<?php endif; ?>><span class="text">否</span></label></div>
...
<div class="col-sm-6">
<textarea class="form-control" id="form-field-8" placeholder="" name="desc" type="text" rows="6"><?php echo $cates['desc']; ?></textarea>
...
<div class="form-group">
<label for="username" class="col-sm-2 control-label no-padding-right">手机栏目内容</label>
<div class="col-sm-12">
<textarea name='sjcontent' id='sjcontent'><?php echo $cates['sjcontent']; ?></textarea>
...
UE.getEditor('sjcontent',{unitialFrameWidth:1000,initialFrameHeight:400,})
</script>
