<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\tparticle\lists.htm";i:1548577885;s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\header.htm";i:1547774329;s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\left.htm";i:1549506592;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url("tparticle/add",array("artid"=>input("cateId"),"cateId"=>input("cateId"))); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
...
<?php if($vo['thumb'] != ''): ?><img src="__PUBLIC__/<?php echo $vo['thumb']; ?>" height='30'><?php else: ?>暂无缩略图<?php endif; ?>
        ...
        <td align="center">
            <a href="<?php echo url('tparticle/edit',array('artid'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                <i class="fa fa-edit"></i> 编辑
            </a>
            <a href="#" onClick="warning('确实要删除吗', '<?php echo url('tparticle/del',array('artid'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
...
<?php if($vo['thumb'] != ''): ?><img src="__PUBLIC__/<?php echo $vo['thumb']; ?>" height='30'><?php else: ?>暂无缩略图<?php endif; ?>
        ...
        <td align="center">
            <a href="<?php echo url('tparticle/edit',array('artid'=>$vo['id'],'cateId'=>input('cateId'))); ?>" class="btn btn-primary btn-sm shiny">
                <i class="fa fa-edit"></i> 编辑
            </a>
            <a href="#" onClick="warning('确实要删除吗', '<?php echo url('tparticle/del',array('artid'=>$vo['id'],'cateId'=>input('cateId'))); ?>')" class="btn btn-danger btn-sm shiny">
                <i class="fa fa-trash-o"></i> 删除
            </a>
        </td>
    </tr>
