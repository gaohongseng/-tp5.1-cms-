<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\tparticle\edit.htm";i:1548577150;s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\header.htm";i:1547774329;s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\left.htm";i:1549185226;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<input type="hidden" value="<?php echo $arts[0]['id']; ?>" name='id'>


        <div class="form-group">
            <label for="username" class="col-sm-2 control-label no-padding-right">标题</label>
            <div class="col-sm-6">
                <input class="form-control" id="username" placeholder="" name="title"  type="text" value="<?php echo $arts[0]['title']; ?>">
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
  <input class="form-control" id="username" placeholder="" name="author"  type="text" value="<?php echo $arts[0]['author']; ?>">
                                  </div>
        </div>  
...
<option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $arts[0]['cateid']): ?>selected="selected"<?php endif; ?>><?php if($vo['level'] != 0): ?>|<?php endif; ?><?php echo str_repeat('-',$vo['level']*4);?><?php echo $vo['catename']; ?></option>
...
<div class="form-group">
  ...
  <input  id="username" placeholder="" name="thumb"  type="file" style='float:left;display:inline-block;'>
<?php if($arts[0]['thumb'] != ''): ?><img src="__PUBLIC__/<?php echo $arts[0]['thumb']; ?>" height='30' style='float:left;'><?php else: ?>暂无缩略图<?php endif; ?>
  ...
  <input class="form-control" id="username" placeholder="" name="keywords"  type="text" value="<?php echo $arts[0]['keywords']; ?>">
...
<textarea class="form-control" id="form-field-8" placeholder="" name="desc"  type="text" rows='6' ><?php echo $arts[0]['desc']; ?></textarea>
...
<div class="form-group">
        ...
        <input name="rec" type="radio" value="1" <?php if($arts[0]['rec'] == 1): ?>checked='checked'<?php endif; ?>>
        <span class="text">是</span>
    </label>
    <label style="margin-left:15px;">
        <input  name="rec" type="radio" value="0" <?php if($arts[0]['rec'] == 0): ?>checked='checked'<?php endif; ?>>
