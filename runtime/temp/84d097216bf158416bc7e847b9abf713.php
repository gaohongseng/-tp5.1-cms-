<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\tpfield\lists.htm";i:1549519491;s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\header.htm";i:1547774329;s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\left.htm";i:1549506592;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url("tpfield/add"); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
...
<tbody>
<?php if(is_array($fieldRes) || $fieldRes instanceof \think\Collection): $i = 0; $__LIST__ = $fieldRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>                  
    <tr>
      <td align="center"><?php echo $vo['id']; ?></td>
      <td align="center">
        <input type="text" style="width:50px;text-align:center;" value="<?php echo $vo['sort']; ?>" name="<?php echo $vo['id']; ?>">
      </td>
      <td align="center"><?php echo $vo['field_cname']; ?></td>
      <td align="center"><?php echo $vo['field_ename']; ?></td>
<!-- 字段类型:1单行文本,2多行文本,3单选按钮,4复选框,5下拉菜单,6附件,7浮点,8模型,9长文本类型 -->
      <td align="center">
        <?php switch($name=$vo['field_type']): case "1": ?>单行文本<?php break; case "2": ?>多行文本<?php break; case "3": ?>单选按钮<?php break; case "4": ?>复选框<?php break; case "5": ?>下拉菜单<?php break; case "6": ?>附件<?php break; case "7": ?>浮点<?php break; case "8": ?>模型<?php break; case "9": ?>长文本类型<?php break; endswitch; ?>
      </td>
      <td align="center"><?php echo $vo->models->model_name; ?></td>
        <td align="center">
            <a href="<?php echo url('tpfield/edit',array('fieldid'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                <i class="fa fa-edit"></i> 编辑
            </a>
            <a href="#" onClick="ajaxdel(this);" class="btn btn-danger btn-sm shiny" id="<?php echo $vo['id']; ?>" table_name="<?php echo $vo->models->table_name; ?>" field_name="<?php echo $vo['field_ename']; ?>">
