<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\tpconf\edit.htm";i:1542348892;s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\header.htm";i:1547774329;s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\left.htm";i:1549080944;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<div class="col-sm-6">
<input class="form-control" id="username" placeholder="" name="cnname" type="text" value="<?php echo $confres['cnname']; ?>">
...
<div class="col-sm-6">
<input class="form-control" id="username" placeholder="" name="enname" type="text" value="<?php echo $confres['enname']; ?>">
...
<div class="col-sm-6">
		<select name="type" id="">
			...
			<option value="4" <?php if($confres['type'] == 4): ?>selected="selected"<?php endif; ?>>复选框</option>
...
<textarea class="form-control" id="form-field-8" placeholder="" name="values"  type="text" rows='6'><?php echo $confres['values']; ?></textarea>
