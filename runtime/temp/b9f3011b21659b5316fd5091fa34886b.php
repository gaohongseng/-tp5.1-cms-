<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:96:"F:\phpstu\PHPTutorial\WWW\tp5cms4\public/../application/admin\view\tpqtarticle\tp3wenzhanadd.htm";i:1543479960;s:85:"F:\phpstu\PHPTutorial\WWW\tp5cms4\public/../application/admin\view\commons\header.htm";i:1547774329;s:83:"F:\phpstu\PHPTutorial\WWW\tp5cms4\public/../application/admin\view\commons\left.htm";i:1547454242;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<label for="catname" class="col-sm-2 control-label no-padding-right">修改说明</label>
<div class="col-sm-6">
<input class="form-control" id="catname" placeholder="" name="shuomin"  type="text">
</div>
...
<div class="form-group">
<label for="catname" class="col-sm-2 control-label no-padding-right">文章标题</label>
<div class="col-sm-6">
<input class="form-control" id="catname" placeholder="" name="title"  type="text">
</div>
<p class="help-block col-sm-4 red">* 必填</p>
</div>
...
<div class="form-group">
<label for="catname" class="col-sm-2 control-label no-padding-right">文章描述</label>
<div class="col-sm-6">
...
<div class="form-group">
<label for="catname" class="col-sm-2 control-label no-padding-right">文章内容</label>
<div class="col-sm-10">
