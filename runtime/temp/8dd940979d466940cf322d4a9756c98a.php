<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\tpmodel\edit.htm";i:1549078984;s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\header.htm";i:1547774329;s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\left.htm";i:1549506592;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<span class="widget-caption">修改模型</span>
</div>
...
<div class="col-sm-6">
<input class="form-control" id="username" placeholder="" name="model_name" type="text" value="<?php echo $modelRes['model_name']; ?>">
...
<div class="form-group">
<label for="username" class="col-sm-2 control-label no-padding-right">附加表名</label>
<div class="col-sm-6">
<input class="form-control" id="username" placeholder="" name="table_name" type="text" value="<?php echo $modelRes['table_name']; ?>">
...
<div class="form-group">
<label for="username" class="col-sm-2 control-label no-padding-right">开启状态</label>




<div class="col-sm-6">
<div class="radio" style="margin-left:10px;float:left;"><label><input name="status" type="radio" value="1" <?php if($modelRes['status'] == 1): ?>checked<?php endif; ?>><span class="text">是</span></label></div>
<div class="radio" style="margin-left:10px;float:left;"><label><input name="status" type="radio" value="0" <?php if($modelRes['status'] == 0): ?>checked<?php endif; ?>><span class="text">否</span></label></div>
</div>
<p class="help-block col-sm-4 red">* 必填</p>
</div>
