<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\tpauthrule\lists.htm";i:1542601909;s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\header.htm";i:1547774329;s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\left.htm";i:1549506592;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url("tpauthrule/add"); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
...
<?php if(is_array($authRuleRes) || $authRuleRes instanceof \think\Collection): $i = 0; $__LIST__ = $authRuleRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>                        
    <tr>
        ...
        <td align="center"><input type='text' style='width:50px;text-align:center;' value="<?php echo $vo['sort']; ?>" name='<?php echo $vo['id']; ?>'></td>
        <td align="center"><?php if($vo['level']!=1){echo '|';}echo str_repeat('---',($vo['level']-1)*2);?><?php echo $vo['title']; ?></td>
      <td align="center"><?php echo $vo['name']; ?></td>
        <td align="center"><?php echo $vo['level']; ?></td>
        <td align="center">
            <a href="<?php echo url('tpauthrule/edit',array('auid'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                <i class="fa fa-edit"></i> 编辑
            </a>
            <a href="#" onClick="warning('确实要删除吗', '<?php echo url('tpauthrule/del',array('auid'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
