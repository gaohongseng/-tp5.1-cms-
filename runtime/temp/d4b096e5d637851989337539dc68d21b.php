<?php /*a:3:{s:73:"F:\phpstu\PHPTutorial\WWW\tp5cms4\application\admin\view\tpcate\lists.htm";i:1547191350;s:75:"F:\phpstu\PHPTutorial\WWW\tp5cms4\application\admin\view\commons\header.htm";i:1547179081;s:73:"F:\phpstu\PHPTutorial\WWW\tp5cms4\application\admin\view\commons\left.htm";i:1547284782;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<?php if(is_array($cateres) || $cateres instanceof \think\Collection || $cateres instanceof \think\Paginator): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>                        
    <tr>
        ...
        <td align="center"><input type='text' style='width:50px;text-align:center;' value="<?php echo htmlentities($cate['sort']); ?>" name='<?php echo htmlentities($cate['id']); ?>'></td>
        <td align="center"><?php if($cate['level'] != 0): ?>|<?php endif; ?>
<?php echo str_repeat('-',$cate['level']*8)?>
        <?php echo htmlentities($cate['catename']); ?>
 ...
 <?php if($cate['rec_index'] == 1): ?>是<?php else: ?><?php endif; ?></td>


<td align="center">
<img src="<?php if($cate["thumb"] != ""): ?>http://tp5cms4.com//<?php echo htmlentities($cate['thumb']); else: ?>http://tp5cms4.com/static/admin/images/defaultpic.gif<?php endif; ?>" alt=""  height='50'>
</td>
