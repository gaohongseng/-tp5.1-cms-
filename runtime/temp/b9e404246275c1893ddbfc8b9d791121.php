<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\tpauthgroup\lists.htm";i:1547708376;s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\header.htm";i:1547774329;s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\left.htm";i:1549506592;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url("tpauthgroup/add"); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
...
<?php if(is_array($authGroupRes) || $authGroupRes instanceof \think\Collection): $i = 0; $__LIST__ = $authGroupRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>              
    <tr>
        <td align="center"><?php echo $vo['id']; ?></td>
 
        <td align="center"><?php echo $vo['title']; ?></td>

<td align="center"><?php if($vo['status'] == 1): ?><a class="btn btn-success">启用</a><?php else: ?><a class="btn btn-danger">禁用</a><?php endif; ?></td>

        <td align="center">
            <a href="<?php echo url('tpauthgroup/edit',array('gpid'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                <i class="fa fa-edit"></i> 编辑
            </a>
            <a href="#" onClick="warning('确实要删除吗', '<?php echo url('tpauthgroup/del',array('gpid'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
