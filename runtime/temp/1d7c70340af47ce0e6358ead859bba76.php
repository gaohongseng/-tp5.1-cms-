<?php /*a:3:{s:78:"F:\phpstu\PHPTutorial\WWW\tp5cms4\application\admin\view\tparttupian\lists.htm";i:1547284485;s:75:"F:\phpstu\PHPTutorial\WWW\tp5cms4\application\admin\view\commons\header.htm";i:1547179081;s:73:"F:\phpstu\PHPTutorial\WWW\tp5cms4\application\admin\view\commons\left.htm";i:1547284782;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<?php if(is_array($list['arttupian']) || $list['arttupian'] instanceof \think\Collection || $list['arttupian'] instanceof \think\Paginator): $i = 0; $__LIST__ = $list['arttupian'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>

      
    <tr>
        <td align="center"><?php echo htmlentities($vo['id']); ?></td>
        <td align="center"><?php echo htmlentities($vo['title']); ?></td>
         <td align="center"><?php echo htmlentities($vo['author']); ?></td>
         
        <td align="center"><?php echo htmlentities($list['catename']); ?></td>
...
缩略图
        ...
        <td align="center">
            <a href="<?php echo url('tparticle/edit'); ?>" class="btn btn-primary btn-sm shiny">
                <i class="fa fa-edit"></i> 编辑
            </a>
            <a href="#" onClick="warning('确实要删除吗', '<?php echo url('tparticle/del'); ?>')" class="btn btn-danger btn-sm shiny">
