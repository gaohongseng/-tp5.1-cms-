<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\tplink\lists.htm";i:1542601960;s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\header.htm";i:1547774329;s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\left.htm";i:1549083627;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url("tplink/add"); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
...
<?php if(is_array($linkres) || $linkres instanceof \think\Collection): $i = 0; $__LIST__ = $linkres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$link): $mod = ($i % 2 );++$i;?>                        
    <tr>
        ...
        <td align="center"><input type='text' style='width:50px;text-align:center;' value="<?php echo $link['sort']; ?>" name='<?php echo $link['id']; ?>'></td>
        <td align="center"><?php echo $link['title']; ?></td>
      <td align="center"><?php echo $link['url']; ?></td>
        <td align="center"><?php echo $link['desc']; ?></td>
        <td align="center">
            <a href="<?php echo url('tplink/edit',array('linkid'=>$link['id'])); ?>" class="btn btn-primary btn-sm shiny">
                <i class="fa fa-edit"></i> 编辑
            </a>
            <a href="#" onClick="warning('确实要删除吗', '<?php echo url('tplink/del',array('linkid'=>$link['id'])); ?>')" class="btn btn-danger btn-sm shiny">
