<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\tplink\add.htm";i:1542348886;s:88:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\header.htm";i:1547774329;s:86:"F:\phpstu\PHPTutorial\WWW\tp5cms4cms\public/../application/admin\view\commons\left.htm";i:1549081515;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<label for="username" class="col-sm-2 control-label no-padding-right">友情链接名称</label>
<div class="col-sm-6">
...
<div class="form-group">
<label for="username" class="col-sm-2 control-label no-padding-right">友情链接地址</label>
<div class="col-sm-6">
<input class="form-control" id="username" placeholder="" name="url" type="text">
...
<div class="form-group">
<label for="username" class="col-sm-2 control-label no-padding-right">友情链接描述</label>
<div class="col-sm-6">
