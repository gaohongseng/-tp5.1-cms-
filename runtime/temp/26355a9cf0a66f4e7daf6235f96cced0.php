<?php /*a:3:{s:76:"F:\phpstu\PHPTutorial\WWW\tp5cms4\application\admin\view\tparticle\lists.htm";i:1547198024;s:75:"F:\phpstu\PHPTutorial\WWW\tp5cms4\application\admin\view\commons\header.htm";i:1547179081;s:73:"F:\phpstu\PHPTutorial\WWW\tp5cms4\application\admin\view\commons\left.htm";i:1547259341;}*/ ?>
<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
...
<?php if(is_array($artres) || $artres instanceof \think\Collection || $artres instanceof \think\Paginator): $i = 0; $__LIST__ = $artres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> 
    <tr>
        ...
        <td align="center"><?php echo mb_substr($vo['title'],0,9,'utf-8');if(strlen($vo['title'])>9){echo '...';}?></td>
         <td align="center"><?php if($vo['author'] != ''): ?><?php echo htmlentities($vo['author']); else: ?>未填写<?php endif; ?></td>
         
        <td align="center"><?php echo htmlentities($vo['catename']); ?></td>
<td align="center"><?php if($vo['rec'] == 1): ?>推荐<?php else: ?>未推荐<?php endif; ?></td>
        <td align="center">
<?php if($vo['thumb'] != ''): ?><img src="http://tp5cms4.com/static/<?php echo htmlentities($vo['thumb']); ?>" height='30'><?php else: ?>暂无缩略图<?php endif; ?>
